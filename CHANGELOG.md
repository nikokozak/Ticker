...
### Changed
- Keep Threads beside the Stream at normal window sizes and use a full-width Thread view only in narrow windows.
...
### Changed
- The PDF outline button now stays visibly active while the outline is open.
